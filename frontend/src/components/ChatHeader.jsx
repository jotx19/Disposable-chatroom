...
import { X, ArrowRight, Settings2Icon } from 'lucide-react';
...
const ChatHeader = () => {
  ...
  const fetchRoomExpiration = async () => {
    const roomId = selectedRoom._id; // Using roomId as input
    ...
    <div className="bg-[#171717] rounded-r-2xl border-base-300">
      <div className="flex items-center justify-between p-5">
        <div className="flex items-center gap-3">
          ...
          <Settings2Icon
            size={20}
            className="text-zinc-400 cursor-pointer ml-2"
